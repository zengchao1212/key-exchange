...
public class MasterClientApplication extends ClientApplication {
    private String message = "大家好，这里是中国";
    ...
    protected void afterExchange() throws Exception {
        super.afterExchange();
        Message.write(MessageType.ENCRYPT_DATA, KeyExchange.encrypt(secretKey, message.getBytes(StandardCharsets.UTF_8)), socketChannel);
    }
}
